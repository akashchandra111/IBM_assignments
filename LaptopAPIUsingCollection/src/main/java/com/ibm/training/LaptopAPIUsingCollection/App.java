package com.ibm.training.LaptopAPIUsingCollection;

import java.util.InputMismatchException;

import com.ibm.training.controller.LaptopHolderController;
import java.util.Scanner;

import org.springframework.context.support.ClassPathXmlApplicationContext;

public class App	{
	private static LaptopHolderController laptopHolder;
	
	public static void main(String... args)	{
		
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("applicationContext.xml", LaptopHolderController.class);
		
		App.laptopHolder = (LaptopHolderController)context.getBean("LaptopHolder");
		//Calling the method questionUser to anonymous object (forever loop)
		new App().questionUser();
	}
